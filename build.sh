...
echo "4) L1 II Single/Dual"
echo "5) L3 II Single/Dual"
echo "6) L7 II NFC"
echo "7) L7 II NoNFC"
echo "8) L7 II Dual"
unset errorchoice
...
case "$choice" in
	...
	4 ) target="L1II-"; variant="SD"; defconfig="cyanogenmod_v1_defconfig";;
	5 ) target="L3II-"; variant="SD"; defconfig="cyanogenmod_vee3_defconfig";;
	6 ) target="L7II-"; variant="NFC"; defconfig="cyanogenmod_vee7_defconfig";;
	7 ) target="L7II-"; variant="NoNFC"; defconfig="cyanogenmod_vee7_nonfc_defconfig";;
	8 ) target="L7II-"; variant="Dual"; defconfig="cyanogenmod_vee7ds_defconfig";;
